    ...
    <main className="min-h-screen bg-[#f5f6f8] text-[#172026]">
      ...
      <section className="lg:pl-64">
        ...
        <div className="mx-auto max-w-[1500px] p-4 md:p-8">
          <div className="mb-7 flex flex-col justify-between gap-4 sm:flex-row sm:items-end"><div><p className="mb-1 text-sm font-medium text-emerald-700">Thứ tư, 19 tháng 8</p><h1 className="text-2xl font-bold tracking-tight md:text-3xl">Chào buổi chiều, Minh</h1><p className="mt-1 text-sm text-slate-500">Đây là tình hình tài nguyên của công ty hôm nay.</p></div><button onClick={() => execute("Mở form đặt tài nguyên", quickBook)} className="flex items-center justify-center gap-2 rounded-xl bg-[#1f5639] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#16452d]"><Plus size={17} /> Đặt tài nguyên</button></div>
